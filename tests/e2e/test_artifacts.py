...
class TestArtifactCRUD:
    ...
    async def test_create_and_read(self, server: str, unique_id: str) -> None:
    ...
    async def test_list_by_type(self, server: str, unique_id: str) -> None:
    ...
    async def test_update_creates_version(self, server: str, unique_id: str) -> None:
    ...
    async def test_get_specific_version(self, server: str, unique_id: str) -> None:
    ...
    async def test_all_valid_types_accepted(self, server: str) -> None:
...
class TestArtifactScoping:
    ...
    async def test_user_isolation(self, server: str) -> None:

...
class TestSessionStateMachine:
    ...
    async def test_idempotent_creation(self, server: str) -> None:
    ...
    async def test_status_progression_to_done(self, server: str) -> None:
    ...
    async def test_pause_active_session(self, server: str) -> None:
    ...
    async def test_status_event_in_sse_stream(self, server: str) -> None:

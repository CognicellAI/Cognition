...
| 2B | `tool-safety`, `async-subagents`, `model-profiles`, `context-controls` | `0.10.0-w2b` | In progress — `tool-safety` active with unit validation green; `async-subagents`, `model-profiles`, and `context-controls` still planned |

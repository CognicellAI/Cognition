...
| 2B | `tool-safety`, `async-subagents`, `model-profiles`, `context-controls` | `0.10.0-w2b` | Partial complete — `tool-safety` merged and validated on dev K8s (`46 passed`, `2 skipped`); `async-subagents`, `model-profiles`, and `context-controls` still planned |

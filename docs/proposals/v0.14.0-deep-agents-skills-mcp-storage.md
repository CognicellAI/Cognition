...
Cognition's skills, artifacts, and sandbox backends have been adapted to the
Deep Agents 0.7 protocol on the release branch. Remaining implementation work
is focused on the MCP OAuth/workload-token-exchange runtime boundary, docs, and
release validation.

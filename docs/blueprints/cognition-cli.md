...
- [client/cli/main.py](https://github.com/CognicellAI/Cognition/blob/main/client/cli/main.py)
- [client/cli/shell.py](https://github.com/CognicellAI/Cognition/blob/main/client/cli/shell.py)
